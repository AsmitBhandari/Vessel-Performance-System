  ...
  if (success) {
    return (
      <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md border-border/50 bg-card/60 backdrop-blur-md text-center">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Please click the link in the email to verify your account. Once verified, you can sign in to the platform.
            </p>
      ...
      <Card className="w-full max-w-md border-border/50 bg-card/60 backdrop-blur-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Sign up to start analyzing voyages and chatting with VPRO AI.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {error && (
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            <div className="space-y-2">
              <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider" htmlFor="fullName">
                Full Name
              </label>
              <input
                id="fullName"
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-border/80 hover:bg-muted/50"
